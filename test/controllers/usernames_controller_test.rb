...
class UsernamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create username" do
    assert_difference('Username.count') do
      post usernames_url, params: { username: { first_name: @username.first_name, last_name: @username.last_name } }
    end
  ...
  test "should update username" do
    patch username_url(@username), params: { username: { first_name: @username.first_name, last_name: @username.last_name } }
